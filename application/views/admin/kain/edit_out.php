                    ...
                    <!-- <label class="control-label col-md-1 col-sm-1 col-xs-12" for="meter">Cm 
				            ...
				            <div class="col-md-12 col-sm-12 col-xs-12">
				              ...
				              <select name="status" id="" class="form-control" required>
				                <option value="" selected disabled>-- Pilih Destination --</option>
                     		<option value="1" <?php if($data->status_out == 1){echo 'selected';} ?>>Pending</option>
                     		<option value="2" <?php if($data->status_out == 2){echo 'selected';} ?>>Lunas</option>    
